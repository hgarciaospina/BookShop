...
public class DefaultBookService implements BookService {
	...
	public BookResponse create(BookRequest bookRequest) {
		...
		var newBook = modelMapper.map(bookRequest, Book.class); 
	...
	public BookResponse update(Long id, BookRequest bookRequest) {
	    ...
	    existingBook = bookRepository.findById(id)	                
		 ...
		 var categoryResponse = categoryRepository.findById(bookRequest.getCategoryId())
	            .orElseThrow(() -> new NotFoundException(CATEGORY_NOT_FOUND_CODE, CATEGORY_NOT_FOUND_MESSAGE + id));
		 
		 var authorResponse = authorRepository.findById(bookRequest.getAuthorId())
		 ...
		 existingBook.setCategory(modelMapper.map(categoryResponse, Category.class));
		 existingBook.setAuthor(modelMapper.map(authorResponse, Author.class));
